...
const Hirer = () => {
  ...
  const onsubmit = (values) => {
    alert(`Hello ${values.FirstName}.You Register succesful`)
    console.log(values);
  };
      ...
      <div className="login-left">
        <div className="welcome-div">
          ...
          <button className="login-button">
            <NavLink to="/userlogin" className="nav-link">Login</NavLink>
          </button>
        </div>
      </div>
      <div className="login-right">
        <div className="employee-hirer">
          <div className="employee-hirer-bg">
            <p className="hirer-employee">
              <NavLink to="/employee"className="hirerpage-employee-nav-link">Emplyoee</NavLink>
            </p>
            <p className="hirer">
              <NavLink to="/hirer" className="hirerpage-hirer-nav-link">Hirer</NavLink>
            </p>
          </div>
        </div>
        <div className="heading">
          <span>Apply as a Hirer</span>
        </div>
